...
async function getRecipes() {
  ...
  const localStoredRecipes = localStorage.getItem('recipes');
  if(localStoredRecipes){
    return JSON.parse(localStoredRecipes);
  }
  /**************************/
  ...
  //            declared above
    for (const urlIndex in RECIPE_URLS){
      const url = RECIPE_URLS[urlIndex];
